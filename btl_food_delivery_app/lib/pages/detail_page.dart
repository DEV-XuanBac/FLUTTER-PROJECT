...
class _DetailPageState extends State<DetailPage> {
  ...
  String? name, id, email, address, wallet, phone;
  ...
  getTheSharedPref() async {
    ...
    if ((address == null || phone == null) && id != null) {
      DocumentSnapshot userDoc = await DatabaseMethods().getUserById(id!);
      if (userDoc.exists) {
        Map<String, dynamic> userData = userDoc.data() as Map<String, dynamic>;
        address ??= userData["address"];
        phone ??= userData["phone"];

        if (address != null) await SharedPref().saveUserAddress(address!);
        if (phone != null) await SharedPref().saveUserPhone(phone!);
      }
    }
      ...
      body: Column(
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              margin: EdgeInsets.only(top: 40.h, left: 12.w, bottom: 8.w),
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                if (id != null) {
                  await DatabaseMethods().updateUserAddress(
                    id!,
                    addressController.text,
                  );
                  await DatabaseMethods().updateUserPhone(
                    id!,
